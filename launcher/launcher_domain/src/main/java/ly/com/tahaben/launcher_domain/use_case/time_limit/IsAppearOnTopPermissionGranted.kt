 ...
 */
class IsAppearOnTopPermissionGranted(private val timeLimiterRepository: TimeLimitRepository) {
    operator fun invoke(): Boolean {
        return timeLimiterRepository.checkIfAppearOnTopPermissionGranted()
    }
}